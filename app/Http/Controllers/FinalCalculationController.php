...
class FinalCalculationController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'data' => ['required', 'array'],
            'data.opening_balance' => ['nullable', 'numeric'],
            'data.total_income' => ['nullable', 'numeric'],
            'data.customs_gov_fees' => ['nullable', 'numeric'],
            'data.credit_unpaid' => ['nullable', 'numeric'],
            'data.office_expenses' => ['nullable', 'numeric'],
            'data.borrowed_amount' => ['nullable', 'numeric'],
            'data.daily_credit_pending' => ['nullable', 'numeric'],
            'data.bank_ac_balance' => ['nullable', 'numeric'],
            'data.cdr_ac_balance' => ['nullable', 'numeric'],
