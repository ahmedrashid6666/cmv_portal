    ...
    return (
        <AuthenticatedLayout header="Bank Accounts">
            ...
            <div className="mb-4 grid grid-cols-1 gap-4 sm:grid-cols-3">
                ...
                <Stat label="Fees & Expenses Paid Out" value={money(totals.customs_paid + totals.gov_paid + totals.other_paid + totals.office_expenses_paid, 'AED')} accent="text-accent-red" />
            ...
            <Card title="Per-Bank Balances">
                <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                        ...
                        <tbody>
                            {banks.length === 0 && <tr><td colSpan="9" className="py-8 text-center text-slate-400">No bank accounts yet. Add them under Master Data → Banks.</td></tr>}
                            {banks.map((b) => (
